...
bitflags! {
    pub flags CR0: u32 {
        ...
        // Not technically supported on 80386 but JOS
        // uses them (or WP at least)
        const CR0_NE = 0b00000000000000000000000000100000,
        const CR0_WP = 0b00000000000000010000000000000000,
        const CR0_AM = 0b00000000000001000000000000000000,
        const CR0_NW = 0b00100000000000000000000000000000,
        const CR0_CD = 0b01000000000000000000000000000000,
